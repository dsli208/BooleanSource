...
public class DownloadRandomizer {
    ...
    /**
     * This generates new Regular Jobs. This has to be called once a timestep.
     * Will return the filesize of the new download job if applicable (or -1 if
     * no new job appeared).
     *
     * @return the size of the job to be added in this time step (or -1 if no
    ...
    /**
     * This generates new Premium Jobs. This has to be called once a timestep.
     * Will return the filesize of the new download job if applicable (or -1 if
     * no new job appeared).
     *
     * @return the size of the job to be added in this time step (or -1 if no
